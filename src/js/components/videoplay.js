...
pageback(){
	...
	render() {
		...
		return (
			<div class="playvideo">
				<span><img onClick={this.pageback.bind(this)} style={{position:'absolute',zIndex:'999999999',left:'20px',top:'-110px',width:'20px'}} src="./src/images/guanbi.png"/></span>
				<div class="zy_media">
		    	<video class="video" poster={data.backgroundPath?data.backgroundPath:data.videoThumb?data.videoThumb:''} data-config='{"mediaTitle": "高颜值--视频"}'>
		        	<source src={data.backgroundvideo?data.backgroundvideo:data.imageUrls?data.imageUrls:''} type="video/mp4"></source>
		      	  您的浏览器不支持HTML5视频
		   	 </video>
			</div>
